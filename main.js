...
const datosClienteFrec1 = {
    nombre: "Alfonsin Konika",
    direccion: new Direccion ("Av. Gordolova", 441, 2, "Las lomas", 32448, "Villa de Alvarez", "Villa de Alvarez"),
    telefono: "310-454-5323" ,
    numeroCliente: 4,
    fechaRegistro: new Fecha (2019, 3, 1)  
}
const datosPedido1 = {
